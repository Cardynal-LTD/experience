...
export default {
  ...
  'blog.pageTitle': 'Blog',
  'blog.pageSubtitle': 'Actualites, conseils et retours d\'experience',
  'blog.recentArticles': 'Articles recents',
  'archive.title': 'Archives',
  'archive.subtitle': 'Tous les articles',
  'about.title': 'A propos',
  'about.label': 'Notre Histoire',
  'about.heroTitle': 'Cardynal est ne d\'une frustration.',
  'about.heroText': 'Des annees a travailler avec des plateformes de service client — Intercom, Zendesk, solutions locales — et toujours les memes problemes : trop cher, des mois a mettre en place, ou un francais qui sent Google Translate. Alors on a construit autre chose.',
  'about.beliefsTitle': 'Ce qu\'on croit',
  'about.belief1Title': 'L\'IA ne doit pas remplacer les gens',
  'about.belief1Text': 'Elle doit les liberer. Nos agents gerent 70% des demandes courantes. Le reste ? Ca va a votre equipe, avec tout le contexte, sans que le client se repete.',
  'about.belief2Title': 'La bonne tech doit etre simple',
  'about.belief2Text': 'Pas de projet d\'integration de plusieurs mois. Pas d\'equipe IT. Pas de prise de tete. 48h apres le "go" — vous etes live.',
  'about.belief3Title': 'Le francais n\'est pas une langue traduite',
  'about.belief3Text': 'On a construit Cardynal des le depart pour le marche francophone. Un francais naturel, et un ton qui parle vraiment a vos clients.',
  'about.teamTitle': 'Qui sommes-nous',
  'about.teamText1': 'Cardynal est construit par une equipe avec une experience solide en automatisation, IA et systemes de service client.',
  'about.teamText2': 'On a vu des entreprises payer une fortune pour des outils qui ne leur conviennent pas vraiment. On a decide de leur donner une alternative — sans compromis sur la qualite, des prix justes, un support dans leur langue.',
  'about.ctaTitle': 'On discute ?',
  'about.ctaText': 'On est toujours ravis d\'echanger avec des entreprises qui cherchent une meilleure facon de servir leurs clients.',
  'about.ctaBtn': 'Contactez-nous',
  'empty.noArticles': 'Aucun article pour le moment',
  'empty.noArticlesDesc': 'Revenez bientot pour du nouveau contenu.',
