...
const PILLAR_ICONS = [
  ...
  // Single-tenant isolation — workspace inside a sealed container
  <svg key="iso" className="size-6" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
    <rect x="3" y="3" width="18" height="18" rx="3" strokeLinecap="round" strokeLinejoin="round" />
    <rect x="8.5" y="8.5" width="7" height="7" rx="1.25" strokeLinecap="round" strokeLinejoin="round" />
  </svg>,
